# This file is based on the v0 version. 
# the matrix inside:
...
# Not tested, but feel like the condition that a/b becoms smaller when it is close to the rupture front, 
# is a higher-order consideration. 
# ---------------- update date: 20 June
...
def update_step(indx, tau, slip, Vslip, taudot, Kij, Kii, my, nx):
    ...
    rate = np.zeros((my, nx), dtype=np.float64) # this matrix is only for the nucleation (index = 1) elements
