...
if __name__ == "__main__":
    ...
    for i in range(step_record):
        ...
        if (number_slip == 0 and new_state == 0) and iev >=0:
            flag_save = True
        ...
        if flag_save:
            event_np[iev, 1] = event_potency * potency_factor
            duration = time - event_np[iev, 0]
            event_np[iev, 2] = duration
            event_np[iev, 3] = event_area
            event_np[iev, 4] = event_max_x
        ...
        if (number_slip == 0 and new_state == 2):
            ...
            event_area = 0
            start_step = i
            print(f'Event {iev} starts at step {i}')
